...
> **Архив — не runtime-контракт.** Исторический corpus/taxonomy audit эпохи
> legacy parser UI. Актуальные контракты: immutable ClickHouse
> `syslog_messages` и Custom AntiFraud / coverage —
> [data-dictionary.md](../data-dictionary.md), [correlation.md](../correlation.md),
> [deployment.md](../deployment.md). Файл оставлен для provenance фикстур и
> заметок по taxonomy Eltex.
